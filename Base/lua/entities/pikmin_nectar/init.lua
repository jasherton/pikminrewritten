...
function ENT:Initialize()
	self:SetModel("models/brewstersmodels/pikmin3/nectar.mdl"); -- self:SetModel("models/props_vehicles/carparts_wheel01a.mdl");
	self:PhysicsInit(SOLID_VPHYSICS);
	self:SetMoveType(MOVETYPE_VPHYSICS);
	self:SetSolid(SOLID_VPHYSICS);
	self:SetMaterial("models/shiny");
	self:SetColor(Color(255, 191, 0, 255)) -- self:SetColor(Color(255, 200, 0, 255))
