...
function ENT:Initialize()
	...
	if (file.Exists("oniondata/yellowonionleaf.txt", "DATA")) then
	local file2 = file.Read("oniondata/yellowonionleaf.txt", "DATA");
	...
	if (file.Exists("oniondata/yellowonionbud.txt", "DATA")) then
				local file02 = file.Read("oniondata/yellowonionbud.txt", "DATA");
	...
	if (file.Exists("oniondata/yellowonionflower.txt", "DATA")) then
				local file002 = file.Read("oniondata/yellowonionflower.txt", "DATA");
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("pik_yellowonion");
	ent:SetPos(SpawnPos);
	ent:Spawn();
	ent:Activate();
	undo.Create("yellow Onion");
		undo.AddEntity(ent);
		undo.SetPlayer(ply);
	undo.Finish();
end
...
file.Write( "oniondata/yellowonionleaf.txt", tostring(self.piknumberleaf))
file.Write( "oniondata/yellowonionbud.txt", tostring(self.piknumberbud))
file.Write( "oniondata/yellowonionflower.txt", tostring(self.piknumberflower))
else
...
file.Write( "oniondata/yellowonionleaf.txt", "0")
end
if (self.piknumberbud > 0) then
file.Write( "oniondata/yellowonionbud.txt", tostring(self.piknumberbud))
else
file.Write( "oniondata/yellowonionbud.txt", "0")
end
if (self.piknumberflower > 0) then
file.Write( "oniondata/yellowonionflower.txt", tostring(self.piknumberflower))
else
file.Write( "oniondata/yellowonionflower.txt", "0")
end
else
file.CreateDir( "oniondata" )
if (self.piknumberleaf > 0) then
...
self.ent2:SetModel("models/anti-noclip_field/cone.mdl")
	...
	self.ent2:SetColor(Color(255, 255, 0))
	self.ent2:Spawn()
	self.ent2:Activate()
...
local pluck = ents.Create("pik_pluckyellow");
			local pluck2 = ents.Create("pik_pluckyellow");
			...
			local pluck12 = ents.Create("pik_pluckyellow");
			if ( !IsValid( pluck ) ) then return end
			pluck:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck2:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck4:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck5:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck6:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck7:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck8:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck9:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck10:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck11:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck12:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-37 ))
			pluck:Spawn()
			pluck2:Spawn()
			pluck3:Spawn()
			pluck4:Spawn()
