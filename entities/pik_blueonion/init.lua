...
function ENT:Initialize()
	...
	if (file.Exists("oniondata/blueonionleaf.txt", "DATA")) then
	local file2 = file.Read("oniondata/blueonionleaf.txt", "DATA");
	...
	if (file.Exists("oniondata/blueonionbud.txt", "DATA")) then
				local file02 = file.Read("oniondata/blueonionbud.txt", "DATA");
	...
	if (file.Exists("oniondata/blueonionflower.txt", "DATA")) then
				local file002 = file.Read("oniondata/blueonionflower.txt", "DATA");
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("pik_blueonion");
	ent:SetPos(SpawnPos);
	ent:Spawn();
	ent:Activate();
	undo.Create("blue Onion");
		undo.AddEntity(ent);
		undo.SetPlayer(ply);
	undo.Finish();
end
...
file.Write( "oniondata/blueonionleaf.txt", tostring(self.piknumberleaf))
file.Write( "oniondata/blueonionbud.txt", tostring(self.piknumberbud))
file.Write( "oniondata/blueonionflower.txt", tostring(self.piknumberflower))
else
...
file.Write( "oniondata/blueonionleaf.txt", "0")
end
if (self.piknumberbud > 0) then
file.Write( "oniondata/blueonionbud.txt", tostring(self.piknumberbud))
else
file.Write( "oniondata/blueonionbud.txt", "0")
end
if (self.piknumberflower > 0) then
file.Write( "oniondata/blueonionflower.txt", tostring(self.piknumberflower))
else
file.Write( "oniondata/blueonionflower.txt", "0")
end
else
file.CreateDir( "oniondata" )
if (self.piknumberleaf > 0) then
...
local pluck = ents.Create("pik_pluckblue");
			...
			local pluck12 = ents.Create("pik_pluckblue");
