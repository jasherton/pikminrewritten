...
function ENT:Initialize()
	...
	if (file.Exists("oniondata/masteronionleaf.txt", "DATA")) then
	local file2 = file.Read("oniondata/masteronionleaf.txt", "DATA");
	...
	if (file.Exists("oniondata/masteronionbud.txt", "DATA")) then
				local file02 = file.Read("data/masteronionbud.txt", "DATA");
	...
	if (file.Exists("oniondata/masteronionflower.txt", "DATA")) then
				local file002 = file.Read("oniondata/masteronionflower.txt", "DATA");
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("pik_masteronion");
	ent:SetPos(SpawnPos);
	ent:Spawn();
	ent:Activate();
	undo.Create("master Onion");
		undo.AddEntity(ent);
		undo.SetPlayer(ply);
	undo.Finish();
end
...
file.Delete( "oniondata/masteronionleaf.txt", tostring(self.piknumberleaf))
file.Delete( "oniondata/masteronionbud.txt", tostring(self.piknumberbud))
file.Delete( "oniondata/masteronionflower.txt", tostring(self.piknumberflower))
else
...
if (file.IsDir( "oniondata", "DATA" )) then
file.Write( "oniondata/masteronionleaf.txt", tostring(self.piknumberleaf))
file.Write( "oniondata/masteronionbud.txt", tostring(self.piknumberbud))
file.Write( "oniondata/masteronionflower.txt", tostring(self.piknumberflower))
else
file.CreateDir( "oniondata" )
file.Write( "oniondata/masteronionleaf.txt", tostring(self.piknumberleaf))
file.Write( "oniondata/masteronionbud.txt", tostring(self.piknumberbud))
...
file.Write( "oniondata/masteronionleaf.txt", "0")
end
if (self.piknumberbud > 0) then
file.Write( "oniondata/masteronionbud.txt", tostring(self.piknumberbud))
else
file.Write( "oniondata/masteronionbud.txt", "0")
end
if (self.piknumberflower > 0) then
file.Write( "oniondata/masteronionflower.txt", tostring(self.piknumberflower))
else
file.Write( "oniondata/masteronionflower.txt", "0")
end
else
file.CreateDir( "oniondata" )
if (self.piknumberleaf > 0) then
...
self.ent2:SetModel("models/anti-noclip_field/cone.mdl")
	...
	self.ent2:SetColor(Color(255, 255, 255))
	self.ent2:Spawn()
	self.ent2:Activate()
...
local rnd = math.random(100, 200);
			...
			local pluck = ents.Create("pik_pluckblue");
			local pluck2 = ents.Create("pik_pluckblue");
			local pluck3 = ents.Create("pik_pluckblue");
			local pluck4 = ents.Create("pik_pluckred");
			local pluck5 = ents.Create("pik_pluckred");
			local pluck6 = ents.Create("pik_pluckred");
			local pluck7 = ents.Create("pik_pluckyellow");
			local pluck8 = ents.Create("pik_pluckyellow");
			local pluck9 = ents.Create("pik_pluckyellow");
			local pluck10 = ents.Create("pik_pluckpurple");
			local pluck11 = ents.Create("pik_pluckpurple");
			local pluck12 = ents.Create("pik_pluckpurple");
			local pluck13 = ents.Create("pik_pluckwhite");
			local pluck14 = ents.Create("pik_pluckwhite");
			local pluck15 = ents.Create("pik_pluckwhite");
			...
			pluck13:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			pluck14:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			pluck15:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			pluck:Spawn()
			pluck2:Spawn()
			pluck3:Spawn()
			pluck4:Spawn()
...
local pluck = ents.Create("pik_pluckblue");
			...
			local pluck3 = ents.Create("pik_pluckyellow");
			local pluck4 = ents.Create("pik_pluckpurple");
			local pluck5 = ents.Create("pik_pluckwhite");
			if ( !IsValid( pluck ) ) then return end
			pluck:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			pluck2:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
...
if (v:GetSkin() == 0) then
			local pluck3 = ents.Create("pik_pluckblue");
			local pluck4 = ents.Create("pik_pluckblue");
			...
			pluck4:Spawn()
			v:Remove()
			elseif (v:GetSkin() == 1) then
			local pluck3 = ents.Create("pik_pluckyellow");
			local pluck4 = ents.Create("pik_pluckyellow");
			if ( !IsValid( pluck3 ) ) then return end
			local rnd = math.random(100, 200);
			local rnd2 = math.random(-100, -200);
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
...
local pluck3 = ents.Create("pik_pluckblue");
local pluck4 = ents.Create("pik_pluckblue");
local pluck5 = ents.Create("pik_pluckblue");
local pluck6 = ents.Create("pik_pluckblue");
local pluck7 = ents.Create("pik_pluckblue");
			if ( !IsValid( pluck3 ) ) then return end
			local rnd = math.random(100, 200);
			local rnd2 = math.random(-100, -200);
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
			...
			local pluck3 = ents.Create("pik_pluckyellow");
			local pluck4 = ents.Create("pik_pluckyellow");
			local pluck5 = ents.Create("pik_pluckyellow");
			local pluck6 = ents.Create("pik_pluckyellow");
			local pluck7 = ents.Create("pik_pluckyellow");
			if ( !IsValid( pluck3 ) ) then return end
			local rnd = math.random(100, 200);
			local rnd2 = math.random(-100, -200);
...
local pluck6 = ents.Create("pik_pluckblue");
local pluck7 = ents.Create("pik_pluckblue");
local pluck8 = ents.Create("pik_pluckblue");
local pluck8 = ents.Create("pik_pluckblue");
local pluck9 = ents.Create("pik_pluckblue");
local pluck10 = ents.Create("pik_pluckblue");
local pluck11 = ents.Create("pik_pluckblue");
			if ( !IsValid( pluck3 ) ) then return end
			local rnd = math.random(100, 200);
			local rnd2 = math.random(-100, -200);
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
		...
		local pluck8 = ents.Create("pik_pluckyellow");
		local pluck9 = ents.Create("pik_pluckyellow");
		local pluck10 = ents.Create("pik_pluckyellow");
		local pluck11 = ents.Create("pik_pluckyellow");
			if ( !IsValid( pluck3 ) ) then return end
			local rnd = math.random(100, 200);
			local rnd2 = math.random(-100, -200);
			pluck3:SetPos( Vector( (self:GetPos().x)+rnd+rnd2,(self:GetPos().y)+rnd+rnd2,(self:GetPos().z)-35 ))
